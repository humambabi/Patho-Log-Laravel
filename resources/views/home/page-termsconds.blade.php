			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumbs">
						<a href="{{ url('/') }}">Home</a><i class="fa fa-angle-double-right"></i><span>Terms & Conditions</span>
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					...
					<div class="text-container last">
						...
						<a class="btn-outline-reg" href="index.html">BACK</a> <!-- use js to go to 'back', not home -->
					</div> <!-- end of text-container -->
				</div>
			</div> <!-- end of row -->
		</div> <!-- end of container -->
