			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="footer-col middle">
						...
						<ul class="list-unstyled li-space-lg">
							...
							<li class="media">
								<i class="fas fa-square"></i>
								<div class="media-body">Contact our support: <a class="turquoise" href="mailto:{{ config('consts.PATHOLOG_EMAIL_SUPPORT') }}">{{ config('consts.PATHOLOG_EMAIL_SUPPORT') }}</a>.</div>
							</li>
						</ul>
					</div>
				</div> <!-- end of col -->
				<div class="col-md-4">
					<div class="footer-col last">
						...
						<span class="fa-stack">
							<a href="mailto:{{ config('consts.PATHOLOG_EMAIL_SUPPORT') }}" class="trans" title="Contact us via email">
								<i class="fas fa-circle fa-stack-2x"></i>
