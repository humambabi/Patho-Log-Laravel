...
Route::get('/privacy-policy',                   [CtrlHome::class, "PrivacyPolicy"]);
Route::get('/frequently-asked-questions',       [CtrlHome::class, "FrequentlyAskedQuestions"]);

# Portal-related pages (for all visitors)
...
# Portal-related pages (for authenticated users)
